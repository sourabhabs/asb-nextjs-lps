...
export const metadata: Metadata = {
  ...
  description: "Thank you for your B.A. Psychology enquiry to Asian School of Business.",
};

export default async function BaPsychologyThankYouPage() {
  ...
  return (
    <>
      ...
      <ThankYouPage
        ...
        courseLabel={courseLabel || "B.A. Psychology"}
      />
    </>
  );
}
