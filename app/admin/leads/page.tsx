...
function serializeLead(lead: LeadAdminDoc): SerializableLead {
  return {
    ...
    completedClass12: lead.completedClass12 || "-",
    class12Score: lead.class12Score || "-",
    englishComfort: lead.englishComfort || "-",
    higherEducationPlanning: lead.higherEducationPlanning || "-",
